    ...
    isOpen && (
      <>
        ...
        <div className="fixed inset-0 z-50 flex h-screen w-screen items-center justify-center">
          <div className="laptop:col-start-2 laptop:col-end-3 laptop:mt-0 laptop:h-auto laptop:w-full laptop:max-w-md mt-10 min-h-full w-full max-w-full rounded-lg bg-rose50 p-8 shadow-lg">
            <div>
              <img src={orderIcon} alt="" className="laptop:mb-2 mb-2" />
              <p
                data-testid="order-confirmed"
                className="laptop:text-3xl mb-2 text-3xl font-bold capitalize tracking-normal"
              >
                order{' '}
                <span className="laptop:inline-block block">confrimed</span>
              </p>
